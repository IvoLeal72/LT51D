...
public class TestCityTour {
    ...
    public void testSumPrice( ){
        assertEquals( 0, Item.sumPrice(new Item[0]) );
        assertEquals( tour.getPrice(), Item.sumPrice(tour));
        assertEquals( tour.getPrice()+tourNight.getPrice(), Item.sumPrice(tour, tourNight));
        assertEquals( tour.getPrice()+tourNight.getPrice()*2, Item.sumPrice(tourNight, tour, tourNight));
    }
